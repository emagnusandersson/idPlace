...
var userSettingDivExtend=function(el){
  ...
  var divCreated=createElement('div').myAppendB('Account created <b></b> ago ', buttonDelete).css({'font-size':'90%', 'border-bottom':'2px solid grey', 'margin-bottom':'1em', 'padding-bottom':'0.5em'});
  el.divDisclaimerW=createElement('div').css({'margin':'0em', 'padding':'0em'});
...
var PropExtend=function(){
  ...
  var crStatisticSpanDefault=function(){
    //var spanNChange=createElement('span').css({'font-weight':'bold'}).attr('name','nChange'), spanLastChange=createElement('span').css({'font-weight':'bold'}).attr('name','lastChange'), spanLastChangeW=createElement('span').myAppendB('(', spanLastChange, ' ago)');
    //var span=createElement('span').myAppendB('Changed ', spanNChange, ' times ', spanLastChangeW).css({'font-size':'85%', 'margin-left':'0.4em'});
    //return span;
